...
const DrawingCourseCard = ({
  ...
  return (
    <dev className="self-stretch flex flex-row items-start justify-left gap-[46px] text-left text-4xs text-white font-inter">
        <div className="rounded-lg bg-white overflow-hidden flex flex-row items-start justify-start cursor-pointer"
       // onClick={onPoductClick}
        style={poductStyle}
      //  useRef={url}
        >
          
        <div className="h-[385.98px] flex flex-col items-start justify-start" style={divStyle} >
          <div className="rounded-lg overflow-hidden flex flex-row items-start justify-start">
            ...
            <Link to={url}>
              <img className="absolute top-[0px] left-[0px] w-[300px] h-[212.19px] object-cover"
                alt=""
                loading="lazy"
                src={header_image}
              /> </Link>
